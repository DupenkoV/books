...
UPD1. Настроил валидацию ISBN-номера. Добавил возможность загружать img. Без "бэка" изображение просто отображается на странице. Вынес ее из формы, чтобы не блокировала добавление книги.
